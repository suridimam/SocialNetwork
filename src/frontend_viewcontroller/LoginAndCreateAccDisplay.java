...
public class LoginAndCreateAccDisplay extends JFrame implements ActionListener {
    ...
    JComboBox school;
    JLabel verifImage;
    String[] schoolStrings = {"--Select a School--", "Ernest Manning", "Bishop Caroll", "E.P. Scarlet", "Western Canada", "Lord Beaverbrook", "Cresent Heights", "Bishop Grandin", "Bishop McNally", "Central Memorial", "Centennial High School", "None of the Above"};
...
//         JOptionPane.showMessageDialog(panel,"Username or Password is already taken or contains : or ¿ ","You messed up!",JOptionPane.ERROR_MESSAGE);
        ...
        if (gender == null) {
            ...
            JOptionPane.showMessageDialog(panel, "Select a school", ":\\", JOptionPane.ERROR_MESSAGE);
